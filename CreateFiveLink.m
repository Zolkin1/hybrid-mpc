...
default_torso_r = [0; 0];               % x, y
thigh_in_torso_theta = 0.0; % 0.6             % rad
...
robot.Xtree{4} = plnr(thigh_in_torso_theta, thigh_in_torso_r);     % right thigh rel to torso
robot.Xtree{5} = plnr(calf_in_thigh_theta, calf_in_thigh_r);      % right calf rel to right thigh
robot.Xtree{6} = plnr(-thigh_in_torso_theta, thigh_in_torso_r);     % left thigh rel to torso
robot.Xtree{7} = plnr(-calf_in_thigh_theta, calf_in_thigh_r);      % left calf rel to left thigh
